...
describe('AzureStore', () => {
  describe('with Azure credentials', function () {
    before(function () {
  ...
  describe('constructor', () => {
    it('should accept a TokenCredential instead of accountKey', function () {
    ...
    it('should throw when neither accountKey nor credential is provided', function () {
      assert.throws(
        () =>
          new AzureStore({
            account: 'testaccount',
    ...
    it('should throw when account is missing', function () {
      assert.throws(
        () =>
          new AzureStore({
            account: '',
    ...
    it('should throw when containerName is missing', function () {
      assert.throws(
        () =>
          new AzureStore({
            account: 'test',
